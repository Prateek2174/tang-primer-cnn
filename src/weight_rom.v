...
assign bias_data_out = bias_dout;

    Gowin_pROM_conv conv_prom(
    ...
    Gowin_pROM_bias bias_prom(
        .dout(bias_dout), //output [7:0] dout
        .clk(clk), //input clk
        .oce(1'b1), //input oce
        .ce(1'b1), //input ce
        .reset(~rst_n), //input reset
        .ad(bias_addr) //input [5:0] ad
    );
